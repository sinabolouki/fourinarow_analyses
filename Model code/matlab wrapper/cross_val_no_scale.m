...
function [params,loglik_train,loglik_test] = cross_val_no_scale(user, num, indir, outdir)
...
[params,loglik_train] = fit_model_no_scale(train);

% Estimate loglike for test data with params from training
loglik_test = estimate_loglik_ibs_no_scale(test,params);
