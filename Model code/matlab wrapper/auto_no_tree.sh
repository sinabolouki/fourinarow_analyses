...
outdir=$HOME/fourinarow/fit_no_tree_strict
...
echo "addpath(genpath('${codedirec}')); cross_val_no_tree($player,$group,'${indir}', '${outdir}'); exit;" | matlab -nodisplay
