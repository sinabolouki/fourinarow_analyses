...
function [params,loglik_train,loglik_test] = cross_val_no_tree(user, num, indir, outdir)
...
[params,loglik_train] = fit_model_no_tree(train);

% Estimate loglike for test data with params from training
loglik_test = estimate_loglik_ibs_no_tree(test,params);
